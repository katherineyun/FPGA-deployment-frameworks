...
class Model_(nn.Module):
    def __init__(self, dilation_rate):
        ...
        # o = [i + 2*p - k - (k-1)*(d-1)]/s + 1 -> p = floor(d / 2)
        self.layer2_pad = nn.ZeroPad2d((0, dilation_rate, 0, 0))
        self.layer2 = nn.Conv2d(in_channels = 16, out_channels = 32, kernel_size = (1, 2), dilation = (1, dilation_rate))
        self.layer3_pad = nn.ZeroPad2d((0, dilation_rate, 0, 0))
        self.layer3 = nn.Conv2d(in_channels = 32, out_channels = 16, kernel_size = (1, 2), dilation = (1, dilation_rate))
