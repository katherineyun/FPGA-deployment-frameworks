"""
official example script for quantizing pytorch networks
"""
...
parser.add_argument(
    '--data_dir',
    default="/home/vitis-ai-user/CK-TOOLS/dataset-imagenet-ilsvrc2012-val-min",
    help='Data set directory, when quant_mode=calib, it is for calibration, while quant_mode=test it is for evaluation')
parser.add_argument(
    '--model_dir',
    default="/workspace/test/torch_resnet",
